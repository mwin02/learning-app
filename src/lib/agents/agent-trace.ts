...
//
// The agent pipelines (topic gate, map builder, track builder, remediation) log
// their stages and tool calls to stdout. A TraceEvent sink lets a caller ALSO
// collect those as structured events to surface in the UI — additive, opt-in via an
