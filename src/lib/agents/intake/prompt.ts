...
export const INTAKE_SYSTEM_PROMPT = [
  ...
  '    them to pick rather than choosing for them. antiList is special: null means',
  '    "unchanged", while an empty list [] means the learner explicitly withdrew',
  '    their exclusions ("actually, include statistics after all") — only send []',
  '    when they say so.',
